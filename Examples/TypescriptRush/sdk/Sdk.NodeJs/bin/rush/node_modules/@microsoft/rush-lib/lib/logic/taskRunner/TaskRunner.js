 ...
 */
class TaskRunner {
    constructor(quietMode, parallelism, changedProjectsOnly, terminal) {
        this._tasks = new Map();
        this._buildQueue = [];
        this._quietMode = quietMode;
        this._hasAnyFailures = false;
        this._changedProjectsOnly = changedProjectsOnly;
        this._terminal = terminal || new node_core_library_1.Terminal(new node_core_library_1.ConsoleTerminalProvider());
